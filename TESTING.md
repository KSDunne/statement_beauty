...
| 5  | View the number of likes on blogs, so that it's easy to see which ones are popular                                                                       | this was a could have and was a won't have in the end                        |  <details><summary>US5</summary><img src="./docs/readme_images/userstories_ss/us5.PNG"></details>   | PASS (WONT HAVE) |
...
| 18 | Like and unlike blog posts, so that I can show other users which posts are interesting (logged in)                                                       | this was a could have and was a won't have in the end                        |  <details><summary>US18</summary><img src="./docs/readme_images/userstories_ss/us18.PNG"></details> | PASS (WONT HAVE) |
